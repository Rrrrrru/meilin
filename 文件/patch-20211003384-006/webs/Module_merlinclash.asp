...
function apply() {
	...
	if(E("merlinclash_koolproxy_rule_enable_d1").checked == true){
		sourceList += "1|koolproxy.txt|https://www.kpguizemeiyoule.top/koolproxy.txt|静态规则>"
	}else{
		sourceList += "0|koolproxy.txt|https://www.kpguizemeiyoule.top/koolproxy.txt|静态规则>"
	}
	if(E("merlinclash_koolproxy_rule_enable_d2").checked == true){
		sourceList += "1|daily.txt|https://www.kpguizemeiyoule.top/daily.txt|每日规则>"
	}else{
		sourceList += "0|daily.txt|https://www.kpguizemeiyoule.top/daily.txt|每日规则>"
	}
	if(E("merlinclash_koolproxy_rule_enable_d3").checked == true){
		sourceList += "1|kp.dat|https://www.kpguizemeiyoule.top/kp.dat|视频规则>"
	}else{
		sourceList += "0|kp.dat|https://www.kpguizemeiyoule.top/kp.dat|视频规则>"
	}
										...
										<div id="tablet_3" style="display: none;">
											...
											<div id="merlinclash-urltestTolerance" style="margin:-1px 0px 0px 0px;">
												<table style="margin:10px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" >																							
													<thead>
														<tr>
															<td colspan="2">Tolerance容差值设定 <a class="hintstyle" href="javascript:void(0);" onclick="openmcHint(16)"><em style="color: gold;">【说明】</em></a></td>
														</tr>
														</thead>
														<tr>
															<th>自定义容差值</th>
