...
url_cdn="https://cdn.jsdelivr.net/gh/flyhigherpi/merlinclash_clash_related/subconverter_rules"
...
move_scrule(){
	...
	if [ "$?" == "0" ];then
		...
		cp -rf /tmp/scrule/rules/rules/* /koolshare/merlinclash/subconverter/rules/  #20210116
		cp -rf /tmp/scrule/rules/ruleconfig/* /koolshare/merlinclash/subconverter/ruleconfig/  #20210116
		chmod +x /koolshare/merlinclash/subconverter/rules/*
		chmod +x /koolshare/merlinclash/subconverter/ruleconfig/*
